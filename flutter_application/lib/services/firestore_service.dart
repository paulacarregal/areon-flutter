...
/// Thin wrapper around FirebaseFirestore providing typed CRUD helpers
/// with automatic metrics and structured logging for observability.
class FirestoreService {
  ...
  Future<DocumentReference<Map<String, dynamic>>> add(
    ...
    try {
      ...
      log.error('Firestore', 'add failed', error: e, stack: st,
          extra: {'col': collectionPath});
      rethrow;
    }
  }
  ...
  Future<void> set(
    ...
    try {
      ...
      metrics.increment('aeon.firestore.error.count');
      log.error('Firestore', 'set failed', error: e, stack: st,
          extra: {'col': collectionPath, 'doc': docId});
      rethrow;
    }
  }
  ...
  Future<void> update(
    ...
    try {
      ...
      metrics.increment('aeon.firestore.error.count');
      log.error('Firestore', 'update failed', error: e, stack: st,
          extra: {'col': collectionPath, 'doc': docId});
      rethrow;
    }
  }
  ...
  Future<void> delete(String collectionPath, String docId) async {
    ...
    try {
      ...
      metrics.increment('aeon.firestore.error.count');
      log.error('Firestore', 'delete failed', error: e, stack: st,
          extra: {'col': collectionPath, 'doc': docId});
      rethrow;
    }
  }
  ...
  Future<DocumentSnapshot<Map<String, dynamic>>> get(
    ...
    try {
      ...
      metrics.increment('aeon.firestore.error.count');
      log.error('Firestore', 'get failed', error: e, stack: st,
          extra: {'col': collectionPath, 'doc': docId});
      rethrow;
    }
  }
